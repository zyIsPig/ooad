...
//
//            //get all constructors from aaa
//            Constructor[] constructorsA = aaa.class.getConstructors();
//            Arrays.stream(constructorsA).forEach(System.out::println);
//
//            //get all parameter types from constructor public aaa(BB bb, CC cc)
...
//
//            //how to instantiate aaa?
//            aaa aObject = (aaa) aaa.class.getDeclaredConstructors()[0].newInstance(objects);
//
